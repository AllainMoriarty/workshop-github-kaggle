...
### Langkah 1: Buat Proyek Baru di VSCode
...
6. Dalam proyek VSCode inisialisasi repositori
![Create Repository](images/2_Struktur_Proyek_Data/1d.png)

7. Staging dan commit
![Create Repository](images/2_Struktur_Proyek_Data/1e.png)

8. Hubungkan repositori lokal dan unggah ke GitHub
![Create Repository](images/2_Struktur_Proyek_Data/1f.png)
