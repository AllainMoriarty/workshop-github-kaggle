...
2. Klik **Register**
![Sign Up Kaggle](images/4_Pengenalan_Kaggle_Notebook/1a.png)
...
![Visit Kaggle Datasets](images/4_Pengenalan_Kaggle_Notebook/2a.png)

2. Cari dataset sederhana, misal: `Iris Species` (ideal untuk pemula)
![Search Dataset](images/4_Pengenalan_Kaggle_Notebook/2b.png)

3. Klik dataset untuk membukanya
![Select Dataset](images/4_Pengenalan_Kaggle_Notebook/2c.png)

4. Klik tombol **New Notebook** untuk membuat notebook baru
![Create New Notebook](images/4_Pengenalan_Kaggle_Notebook/2d.png)

5. Kaggle otomatis membuka editor notebook dengan dataset tersebut terpasang
![Notebook Editor Opens](images/4_Pengenalan_Kaggle_Notebook/2e.png)

6. Ganti judul notebook (klik di bagian atas) → contoh: `workshop-eda-iris`
![Rename Notebook](images/4_Pengenalan_Kaggle_Notebook/2f.png)
...
df.head()
```
![Code Example](images/4_Pengenalan_Kaggle_Notebook/2g.png)

8. Klik tombol **▶️ Run** untuk menjalankan kode. Hasilnya akan muncul di bawah sel
![Run Code](images/4_Pengenalan_Kaggle_Notebook/2h.png)
...
![Save Version Button](images/4_Pengenalan_Kaggle_Notebook/3a.png)
...
2. Cari dataset `Iris Species` atau dataset lain
